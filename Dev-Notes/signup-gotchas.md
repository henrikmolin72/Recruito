...
6. ~~The coming-soon gate must let `/callback` through~~ — gate deleted 2026-09-06 (GA); any future pre-launch gate must still exempt `/callback`, `/api/webhooks`, `/api/cron`, `/api/guarantee/reminders`.
