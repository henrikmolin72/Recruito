...
INSERT INTO skills (name, slug, category, aliases) VALUES
  ...
  ('GraphQL', 'graphql', 'technical', ARRAY[]::TEXT[]),
  ...
  ('Communication', 'communication', 'soft', ARRAY[]::TEXT[]),
  ('English', 'english', 'language', ARRAY[]::TEXT[]),
