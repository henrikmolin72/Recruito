        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                    <MetricCard
                        label="Konvertering (hire rate)"
                        value={metrics.hireRate}
                        suffix="%"
                        icon={Target}
                        color="bg-brand-600"
                        description={`${metrics.candidatesHired} av ${metrics.candidatesSubmitted} kandidater`}
                    />
                    <MetricCard
                        label="Snitt tid till anställning"
                    ...
                    />
                    <MetricCard
                        label="Totala placeringar"
                        value={metrics.totalPlacements}
                        icon={Award}
                        color="bg-amber-600"
                    />
                    <MetricCard
                        label="Aktiva garantier"
                        value={metrics.activePlacements}
                        icon={Shield}
                        color="bg-emerald-600"
                    />
                    <MetricCard
                        label="Garantiresultat"
                ...
                <div className="space-y-1.5 pt-1">
                    <div className="flex justify-between text-xs">
                        <span className="text-muted-foreground">Konverteringsgrad</span>
                ...
                <div className="space-y-1.5">
                    <div className="flex justify-between text-xs">
                        <span className="text-muted-foreground">Garantiframgång</span>
