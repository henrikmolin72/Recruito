                    ...
                    <div className="space-y-5">
                        <FieldRow>
                            <div>
                                ...
                                <Input type="date" name="first_contact_date" defaultValue={draftTextFields["first_contact_date"] || ""} max={new Date().toISOString().slice(0, 10)} className="date-input-lg h-11 bg-slate-50 border-slate-200" />
                            </div>
                            <div>
