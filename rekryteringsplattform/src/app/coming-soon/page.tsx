...
export default function ComingSoonPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#020d1a] flex items-center justify-center">
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(0,180,200,0.18) 0%, transparent 70%)",
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(0,80,180,0.20) 0%, transparent 70%)",
        ...
        {[...Array(20)].map((_, i) => (
          <div
            ...
            style={{
              ...
              borderRadius: "50%",
              background: `rgba(0, ${150 + (i * 7) % 100}, ${180 + (i * 11) % 75}, 0.6)`,
              top: `${(i * 37 + 5) % 90}%`,
              left: `${(i * 53 + 10) % 90}%`,
      ...
      >
        ...
        <div
          style={{
            ...
            filter: "drop-shadow(0 0 40px rgba(0, 180, 210, 0.5))",
            marginBottom: "2rem",
          }}
        >
          <Image
        ...
        <div
          style={{
            height: "2px",
            background:
              "linear-gradient(90deg, transparent, rgba(0,180,210,0.8), rgba(0,100,200,0.8), transparent)",
        ...
        {/* Tagline */}
        <p
          className="text-white/60 text-base tracking-[0.25em] uppercase font-light"
          style={{
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{
                ...
                height: i === 1 ? "10px" : "6px",
                borderRadius: "50%",
                background: i === 1 ? "rgba(0,190,210,1)" : "rgba(0,190,210,0.4)",
      ...
      <style>{`
        ...
        @keyframes glowPulse {
          0%, 100% { filter: drop-shadow(0 0 30px rgba(0,180,210,0.4)); }
          50%       { filter: drop-shadow(0 0 55px rgba(0,180,210,0.75)); }
        }
        @keyframes dotPulse {
