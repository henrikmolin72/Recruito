...
import { Briefcase, Building2, CheckCircle2, MapPin, ShieldCheck } from "lucide-react";
            ...
            <CardContent className="p-6 lg:p-7">
              {isSubmitted ? (
                ...
                <>
                  ...
                  <PublicApplicationForm mandateId={mandateId} action={submitPublicMandateApplication} />
                </>
              )}
            </CardContent>
          </Card>
